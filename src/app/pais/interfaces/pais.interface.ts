...
export class Convert {
  public static toIObjResponse(json: string): IObjResponse[] {
      return cast(JSON.parse(json), a(r("IObjResponse")));
  }

  public static iObjResponseToJson(value: IObjResponse[]): string {
      return JSON.stringify(uncast(value, a(r("IObjResponse"))), null, 2);
  }
}
